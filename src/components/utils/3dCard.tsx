...
export const HoverBody = ({
  ...
  return (
    <div
      className={cn(
        "h-96 aspect-square [transform-style:preserve-3d]  [&>*]:[transform-style:preserve-3d]",
        className
      )}
      style={style}
    >
...
export const HoverItem = ({
  ...
  children?: React.ReactNode;
  className?: string;
  translateX?: IItemValue|IItemValue;
  translateY?: IItemValue|IItemValue;
  translateZ?: IItemValue|IItemValue;
  rotateX?: IItemValue|IItemValue;
  rotateY?: IItemValue|IItemValue;
  rotateZ?: IItemValue|IItemValue;
  scale?: IItemValue;
  opacity?: IItemValue;
}) => {
